...
type Documents = {
  ...
  "query EntityNotes($id: ID!) {\n  entity(id: $id) {\n    id\n    backlinks {\n      id\n      authorId\n      title\n      content\n      visibility\n      recipientIds\n      updatedAt\n    }\n  }\n}": typeof types.EntityNotesDocument;
  ...
  "mutation UploadNoteAttachment($noteId: ID!, $file: Upload!) {\n  uploadNoteAttachment(noteId: $noteId, file: $file) {\n    id\n    fileName\n    mimeType\n    sizeBytes\n    url\n  }\n}": typeof types.UploadNoteAttachmentDocument;
};
const documents: Documents = {
  ...
  "mutation UploadEntityImage($entityId: ID!, $file: Upload!) {\n  uploadEntityImage(entityId: $entityId, file: $file) {\n    id\n    image\n  }\n}":
    types.UploadEntityImageDocument,
  "mutation UploadMapImage($campaignId: ID!, $file: Upload!) {\n  uploadMapImage(campaignId: $campaignId, file: $file) {\n    id\n    url\n    fileName\n    width\n    height\n  }\n}":
    types.UploadMapImageDocument,
  "mutation UploadNoteAttachment($noteId: ID!, $file: Upload!) {\n  uploadNoteAttachment(noteId: $noteId, file: $file) {\n    id\n    fileName\n    mimeType\n    sizeBytes\n    url\n  }\n}":
    types.UploadNoteAttachmentDocument,
};
 ...
 */
export function graphql(
  source: "mutation DeleteAttachment($id: ID!) {\n  deleteAttachment(id: $id)\n}",
): (typeof documents)["mutation DeleteAttachment($id: ID!) {\n  deleteAttachment(id: $id)\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
 ...
 */
export function graphql(
  source: "query Entity($id: ID!) {\n  entity(id: $id) {\n    id\n    name\n    type\n    category\n    description\n    image\n    color\n    visibility\n    hiddenFromGraph\n  }\n}",
): (typeof documents)["query Entity($id: ID!) {\n  entity(id: $id) {\n    id\n    name\n    type\n    category\n    description\n    image\n    color\n    visibility\n    hiddenFromGraph\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
  source: "query EntityNotes($id: ID!) {\n  entity(id: $id) {\n    id\n    backlinks {\n      id\n      authorId\n      title\n      content\n      visibility\n      recipientIds\n      updatedAt\n    }\n  }\n}",
): (typeof documents)["query EntityNotes($id: ID!) {\n  entity(id: $id) {\n    id\n    backlinks {\n      id\n      authorId\n      title\n      content\n      visibility\n      recipientIds\n      updatedAt\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
 ...
 */
export function graphql(
  source: "query Note($id: ID!) {\n  note(id: $id) {\n    id\n    campaignId\n    authorId\n    title\n    content\n    visibility\n    recipientIds\n    createdAt\n    updatedAt\n    linkedEntities {\n      id\n      name\n      type\n      category\n      description\n      image\n      color\n      visibility\n      hiddenFromGraph\n    }\n    linkedNotes {\n      id\n      title\n    }\n    children {\n      id\n      authorId\n      title\n      content\n      visibility\n    }\n    backlinks {\n      id\n      title\n    }\n    attachments {\n      id\n      url\n      fileName\n      mimeType\n      sizeBytes\n      createdAt\n    }\n  }\n}",
): (typeof documents)["query Note($id: ID!) {\n  note(id: $id) {\n    id\n    campaignId\n    authorId\n    title\n    content\n    visibility\n    recipientIds\n    createdAt\n    updatedAt\n    linkedEntities {\n      id\n      name\n      type\n      category\n      description\n      image\n      color\n      visibility\n      hiddenFromGraph\n    }\n    linkedNotes {\n      id\n      title\n    }\n    children {\n      id\n      authorId\n      title\n      content\n      visibility\n    }\n    backlinks {\n      id\n      title\n    }\n    attachments {\n      id\n      url\n      fileName\n      mimeType\n      sizeBytes\n      createdAt\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
 ...
 */
export function graphql(
  source: "mutation UploadEntityImage($entityId: ID!, $file: Upload!) {\n  uploadEntityImage(entityId: $entityId, file: $file) {\n    id\n    image\n  }\n}",
): (typeof documents)["mutation UploadEntityImage($entityId: ID!, $file: Upload!) {\n  uploadEntityImage(entityId: $entityId, file: $file) {\n    id\n    image\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
 ...
 */
export function graphql(
  source: "mutation UploadNoteAttachment($noteId: ID!, $file: Upload!) {\n  uploadNoteAttachment(noteId: $noteId, file: $file) {\n    id\n    fileName\n    mimeType\n    sizeBytes\n    url\n  }\n}",
): (typeof documents)["mutation UploadNoteAttachment($noteId: ID!, $file: Upload!) {\n  uploadNoteAttachment(noteId: $noteId, file: $file) {\n    id\n    fileName\n    mimeType\n    sizeBytes\n    url\n  }\n}"];
